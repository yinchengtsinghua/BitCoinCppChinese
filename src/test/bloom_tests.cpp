...
{
//与Bloom_Create_Insert_Serialize相同的测试，但我们添加了100的ntweak
...
{
//随机实交易（B4749F017444B051C44DFD2720E88F314FF94F3DD6D56D40EF65854FCD7FFF6B）
...
//以及一个花费它的人（E2769B09E784F32F62EF849763D4F45B98E07BA65867343B915FF832B10436）
...
{
//随机实块（00000000 5a4ded781e667e06ceeffb71410b51fe0d5adc3e5a27ecbec34ae6）
//有4个TXPS
    CBlock block;
...
//匹配第二个事务的输出（地址1dztzabhudm7t3qvukbz4qxmrpkg8jsfb5的pubkey）
//这应该与第三个事务匹配，因为它花费匹配的输出
//它还匹配第四个事务，第四个事务再次花费到pubkey
...
//匹配第二个事务的输出（地址1dztzabhudm7t3qvukbz4qxmrpkg8jsfb5的pubkey）
//这不应该与第三个事务匹配，尽管它花费匹配的输出
//它将与第四个事务匹配，第四个事务的pay-to-pubkey输出具有相同的地址
    filter.insert(ParseHex("044a656f065871a353f216ca26cef8dde2f03e8c16202d2e8ad769f02032cb86a5eb5e56842e92e19141d60a01928f8dd2c875a390f67c1f6c94cfc617c0ea45af"));
...
{
//随机实块（00000000000DAB0130BCC991D3D7AE6B81AA6F50A798888DFE62337458DC45）
//用一个TX
    CBlock block;
...
{
//随机实块（00000000000 b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4）
//有7个TXPS
    CBlock block;
...
//假阳性率是1%，所以如果
//测试10000个随机键。我们得到最坏情况的假阳性
//过滤器尽可能满时的行为，即
//当我们插入一减去Nelement*2的整数倍时。
    unsigned int nHits = 0;
    for (int i = 0; i < 10000; i++) {
        if (rb1.contains(RandomData()))
            ++nHits;
    }
//运行test_bitcoin with--log_level=message查看boost_test_消息：
