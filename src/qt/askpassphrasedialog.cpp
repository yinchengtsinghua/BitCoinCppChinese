...
{
    /*检测Caps Lock。
     *没有好的独立于操作系统的方法来检查qt中的密钥状态，但是我们
     *可以通过检查以下情况来检测Caps Lock：
     *SHIFT键是向下的，结果是小写字符，或者
     *SHIFT键不向下，结果为大写字符。
     **/
